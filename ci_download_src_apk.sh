...
ARMV8_URL="https://apk.proyectomagirecoesp.com/rika-ren/com.aniplex.magireco.arm8.apk"
ARMV7_URL="https://apk.proyectomagirecoesp.com/rika-ren/com.aniplex.magireco.arm7.apk"
...
mv out.apk "./apk/src_3.1.8.apk"

curl -A "${UA}" -o out.apk -L "${ARMV7_URL}"
#verify_apk out.apk "${SRCAPK_CERT_SHA256}" && 
mv out.apk "./armv7apk/armv7src_3.1.8.apk"